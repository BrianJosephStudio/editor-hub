...
export const AgentTags: TagObject[] = [
    ...
    {tag:"cypher",displayName:"Cypher",description:"Player is playing Cypher", unique: true, timeless: true, protected: true, keybind: "", id: "a005"},
    ...
    {tag:"reyna",displayName:"Reyna",description:"Player is playing Reyna", unique: true, timeless: false, protected: true, keybind: "", id: "a018g"},
...
export const GenericTags: TagSystem = {
    guns: {
        tags: [
            {tag:"ares",displayName:"Ares",description:"Player gets a kill with the Ares", unique: true, timeless: false, protected: false, keybind: "a", id: "g001"},
            {tag:"bucky",displayName:"Bucky",description:"Player gets a kill with the Bucky", unique: true, timeless: false, protected: false, keybind: "b", id: "g002"},
            {tag:"bulldog",displayName:"Bulldog",description:"Player gets a kill with the Bulldog", unique: true, timeless: false, protected: false, keybind: "l", id: "g003"},
            {tag:"classic",displayName:"Classic",description:"Player gets a kill with the Classic", unique: true, timeless: false, protected: false, keybind: "c", id: "g004"},
            {tag:"frenzy",displayName:"Frenzy",description:"Player gets a kill with the Frenzy", unique: true, timeless: false, protected: false, keybind: "f", id: "g005"},
            {tag:"ghost",displayName:"Ghost",description:"Player gets a kill with the Ghost", unique: true, timeless: false, protected: false, keybind: "g", id: "g006"},
            {tag:"guardian",displayName:"Guardian",description:"Player gets a kill with the Guardian", unique: true, timeless: false, protected: false, keybind: "d", id: "g007"},
            {tag:"judge",displayName:"Judge",description:"Player gets a kill with the Judge", unique: true, timeless: false, protected: false, keybind: "j", id: "g008"},
            {tag:"marshal",displayName:"Marshal",description:"Player gets a kill with the Marshal", unique: true, timeless: false, protected: false, keybind: "m", id: "g009"},
            {tag:"operator",displayName:"Operator",description:"Player gets a kill with the Operator", unique: true, timeless: false, protected: false, keybind: "o", id: "g010"},
            {tag:"odin",displayName:"Odin",description:"Player gets a kill with the Odin", unique: true, timeless: false, protected: false, keybind: "i", id: "g011"},
            {tag:"phantom",displayName:"Phantom",description:"Player gets a kill with the Phantom", unique: true, timeless: false, protected: false, keybind: "p", id: "g012"},
            {tag:"sheriff",displayName:"Sheriff",description:"Player gets a kill with the Sheriff", unique: true, timeless: false, protected: false, keybind: "s", id: "g013"},
            {tag:"shorty",displayName:"Shorty",description:"Player gets a kill with the Shorty", unique: true, timeless: false, protected: false, keybind: "r", id: "g014"},
            {tag:"spectre",displayName:"Spectre",description:"Player gets a kill with the Spectre", unique: true, timeless: false, protected: false, keybind: "c", id: "g015"},
            {tag:"stinger",displayName:"Stinger",description:"Player gets a kill with the Stinger", unique: true, timeless: false, protected: false, keybind: "t", id: "g016"},
            {tag:"vandal",displayName:"Vandal",description:"Player gets a kill with the Vandal", unique: true, timeless: false, protected: false, keybind: "v", id: "g017"},
            {tag:"knife",displayName:"Knife",description:"Player gets a kill with their Knife", unique: true, timeless: false, protected: false, keybind: "k", id: "g018"}
        ],
        keybindGroup: "g",
        exclusive: false,
        iterable: false,
